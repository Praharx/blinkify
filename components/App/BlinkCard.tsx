...
const DrawingCanvas: React.FC<{
  ...
  setBlinkName: React.Dispatch<React.SetStateAction<string>>,
              ...
              <div className="w-full relative">
                ...
                {!item.isEditing ?
                  <div className="absolute top-0 right-0">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 text-gray-600" fill="white" viewBox="0 0 24 24" stroke="currentColor">
