  ...
  const features = [
    {
      ...
      description:
        "Analyze your current active blinks sale and get insights on how to improve your sales",
      skeleton: <SkeletonOne />,
      className:
        "col-span-1 lg:col-span-4 border-b lg:border-r  border-neutral-800",
    },
    {
      title: "Create blinks for you products",
      description:
        "Create blinks for your products and sell them through Solana Blinks",
    ...
    {
      title: "Secure transaction with decentralized smart contracts",
      description:
        "Use our decentralized smart contracts to sell your products securely and transparently",
...
export const SkeletonThree = () => {
  return (
    ...
    //       <Image
    //         src="https://unsplash.com/photos/an-abstract-blue-background-with-curved-curves-7cSSg-1365U"
    //         alt="header"
    //         width={800}
    //         height={800}
...
export const SkeletonTwo = () => {
  const images = [
    "https://unsplash.com/photos/an-abstract-blue-background-with-curved-curves-7cSSg-1365U",
    "https://unsplash.com/photos/an-abstract-blue-background-with-curved-curves-7cSSg-1365U",
    "https://unsplash.com/photos/an-abstract-blue-background-with-curved-curves-7cSSg-1365U",
    "https://unsplash.com/photos/an-abstract-blue-background-with-curved-curves-7cSSg-1365U",
    "https://unsplash.com/photos/an-abstract-blue-background-with-curved-curves-7cSSg-1365U",
      ...
      <div className="flex flex-row -ml-20">
        {images.map((image, idx) => (
          <motion.div
            ...
            whileTap="whileTap"
            className="rounded-xl -mr-4 mt-4 p-1 bg-black border-white border  flex-shrink-0 overflow-hidden"
          >
            <Image
              src={"/image.jpg"}
              alt="bali images"
